        ...
        <div class="collapse" id="pagesExamples">
          <ul class="nav ms-4 ps-3">
              ...
              <div class="collapse" id="profileExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/profile/overview.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/profile/teams.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/profile/projects.html"
                    >
              ...
              <div class="collapse" id="usersExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/users/reports.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/users/new-user.html"
                    >
              ...
              <div class="collapse" id="accountExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/account/settings.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/account/billing.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/account/invoice.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/account/security.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> S </span>
              ...
              <div class="collapse" id="projectsExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/projects/general.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/projects/timeline.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> T </span>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/projects/new-project.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> N </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/pricing-page.html"
              >
                <span class="sidenav-mini-icon"> P </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/messages.html"
              >
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/rtl-page.html"
              >
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/widgets.html"
              >
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/charts.html"
              >
                <span class="sidenav-mini-icon"> C </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/sweet-alerts.html"
              >
                <span class="sidenav-mini-icon"> S </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/pages/notifications.html"
              >
        ...
        <div class="collapse" id="applicationsExamples">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/applications/kanban.html"
              >
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/applications/wizard.html"
              >
                <span class="sidenav-mini-icon"> W </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/applications/datatables.html"
              >
                <span class="sidenav-mini-icon"> D </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/applications/calendar.html"
              >
                <span class="sidenav-mini-icon"> C </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/applications/analytics.html"
              >
                <span class="sidenav-mini-icon"> A </span>
        ...
        <div class="collapse" id="ecommerceExamples">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/overview.html"
              >
              ...
              <div class="collapse" id="productsExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/products/new-product.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> N </span>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/products/edit-product.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/products/product-page.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> P </span>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/products/products-list.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> P </span>
              ...
              <div class="collapse" id="ordersExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/orders/list.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/orders/details.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> O </span>
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/ecommerce/referral.html"
              >
                <span class="sidenav-mini-icon"> R </span>
              ...
              <div class="collapse" id="signinExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/signin/basic.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> B </span>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/signin/cover.html"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/signin/illustration.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> I </span>
              ...
              <div class="collapse" id="signupExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/signup/basic.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> B </span>
                      <span class="sidenav-normal"> Basic </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/signup/cover.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> C </span>
                      <span class="sidenav-normal"> Cover </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/signup/illustration.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> I </span>
                      <span class="sidenav-normal"> Illustration </span>
                    </a>
              ...
              <div class="collapse" id="resetExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/reset/basic.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> B </span>
                      <span class="sidenav-normal"> Basic </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/reset/cover.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> C </span>
                      <span class="sidenav-normal"> Cover </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/reset/illustration.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> I </span>
                      <span class="sidenav-normal"> Illustration </span>
                    </a>
              ...
              <div class="collapse" id="lockExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/lock/basic.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> B </span>
                      <span class="sidenav-normal"> Basic </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/lock/cover.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> C </span>
                      <span class="sidenav-normal"> Cover </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/lock/illustration.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> I </span>
                      <span class="sidenav-normal"> Illustration </span>
                    </a>
              ...
              <div class="collapse" id="StepExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/verification/basic.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> B </span>
                      <span class="sidenav-normal"> Basic </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/verification/cover.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> C </span>
                      <span class="sidenav-normal"> Cover </span>
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/verification/illustration.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> I </span>
                      <span class="sidenav-normal"> Illustration </span>
                    </a>
              ...
              <div class="collapse" id="errorExample">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/error/404.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> E </span>
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/authentication/error/500.html"
                    >
                      <span class="sidenav-mini-icon text-xs"> E </span>
